...
Generated: 2026-03-24T07:08:45.151462+00:00
Overall: **PASS**
Scenario ID: 975
Run ID: 1768
...
| preview_very_low | PASS | status=200; row_count=264; ratio=0.2 |
| preview_low | PASS | status=200; row_count=420; ratio=0.4 |
| preview_medium | PASS | status=200; row_count=312; ratio=1.0 |
| preview_high | PASS | status=200; row_count=504; ratio=1.5 |
| preview_extreme | PASS | status=200; row_count=750; ratio=2.0 |
| apply_randomizer | PASS | status=200; applied_rows=1000 |
| run_scenario | PASS | status=200 |
| list_runs_and_pick_run_id | PASS | status=200; run_id=1768 |
| summary_has_by_time_breakdown | PASS | status=200; by_time_rows=4 |
